...
@endsection
@section('main')
<form action="{{route('subProduct.store')}}" method="post" class=" px-6 py-6 rounded-md space-y-7" enctype="multipart/form-data">
    @csrf
    <div class="bg-white py-12 rounded-lg shadow-md">
        ...
        <div class="px-10">
            <label for="button_url" class="block text-sm leading-5 font-medium text-gray-700">
                Button URL 
            </label>
            <div class="mt-1 relative rounded-md shadow-sm">
        ...
        <div class="px-10">
            <label for="is_has_button" class="block text-sm leading-5 font-medium text-gray-700">
        ...
        <div class="px-10">
            <label for="design_pattern" class="block text-sm leading-5 font-medium text-gray-700">
                Design Pattern <span class="text-red-600"> * </span>
            </label>
            <div class="mt-1 relative rounded-md shadow-sm">
