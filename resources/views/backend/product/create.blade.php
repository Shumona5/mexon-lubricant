...
<form action="{{route('product.store')}}" method="post" class=" px-6 py-6 rounded-md space-y-7" enctype="multipart/form-data">
    ...
    <div class="bg-white py-12 rounded-lg shadow-md">
        ...
        <div class="px-10">
            ...
            <div class="mt-1 relative rounded-md shadow-sm">
                <!-- <input required id="description" value="{{ old('description') }}" name="description" type="text" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:ring-2 focus:border-blue-200 focus:outline-none" placeholder="Description " /> -->
                <textarea  id="content" value="{{ old('description') }}" name="description" class="ckeditor form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:ring-2 focus:border-blue-200 focus:outline-none" placeholder="Description"></textarea>
            </div>
            @error('description')
            <p class="text-red-600 mt-5">{{ $message }}</p>
            @enderror
        ...
        <!-- <div class="px-10">
            ...
            <div class="mt-1 relative rounded-md shadow-sm">
                <input id="quantity" value="{{ old('quantity') }}" name="quantity" type="number" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:ring-2 focus:border-blue-200 focus:outline-none" placeholder="Enter quantity" />
            </div>
            @error('quantity')
            <p class="text-red-600 mt-5">{{ $message }}</p>
            @enderror
        ...
        <div class="px-10">
            ...
            <div class="mt-1 relative rounded-md shadow-sm">
                <input required id="price" value="{{ old('price') }}" name="price" type="number" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:ring-2 focus:border-blue-200 focus:outline-none" placeholder="Enter Product Price" />
            </div>
            @error('price')
            <p class="text-red-600 mt-5">{{ $message }}</p>
            @enderror
        ...
        <!-- <div class="px-10">
            ...
            <div class="mt-1 relative rounded-md shadow-sm">
                <input id="discount_type" value="{{ old('discount_type') }}" name="discount_type" type="number" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:ring-2 focus:border-blue-200 focus:outline-none" placeholder="Enter Discount Type " />
            </div>
            @error('discount_type')
            <p class="text-red-600 mt-5">{{ $message }}</p>
            @enderror
