...
<div class="container flex flex-col px-8">
    ...
    <div class="flex items-center justify-between px-9">
        ...
        <div>
            <form action="{{route('slider.list')}}" method="get" class="w-full">
                <div class="flex items-center justify-center mb-10">
                    ...
                    <div class="mt-1.5">
                        ...
                        <a href="{{route('slider.list')}}" class="focus:outline-none space-x-6 bg-indigo-600 text-white rounded-md px-4 py-2.5 ml-5 mt-5">
                            Reset
                        </a>
                        @endif
                ...
                @foreach($sliders as $key=>$data)   
                    ...
                    <td class="text-sm text-gray-900">
                        ...
                        <td class="flex px-8 py-8 space-x-2 text-sm font-medium text-right whitespace-nowrap">
                            <a title="Edit" href="{{route('slider.edit',$data->id)}}" class="text-indigo-600 hover:text-indigo-900">
                                <svg class="w-5 h-5 text-blue-600" viewBox="0 0 20 20" fill="currentColor">
                                    <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" />
                                    <path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd" />
                                </svg>
                            </a>
                            <a title="Delete" href="{{route('slider.delete',$data->id)}}" onclick="return confirm('Are you sure you want to delete it ?')" class="text-indigo-600 hover:text-indigo-900">
