                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="flex px-8 py-8 space-x-2 text-sm font-medium text-right whitespace-nowrap">
                            ...
                            <a title="Delete" href="{{route('district.deleteDistrict',$district->id)}}"
