...
@section('title')
Business Promotion Create
@endsection
@section('main')
<form action="{{route('businessPromotion.store')}}" method="post" class=" px-6 py-6 rounded-md space-y-7">
    @csrf
        ...
        <div class="px-10">
            ...
            <div class="mt-1 relative rounded-md shadow-sm">
                <input id="title" value="{{old('title')}}" name="title" type="text"
                    ...
                    placeholder="Enter business promotion name" />
            </div>
