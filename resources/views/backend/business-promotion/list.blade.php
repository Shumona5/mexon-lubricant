    ...
    <div class="flex items-center justify-between px-9">
        <div class="">
            <span class="inline-flex rounded-md shadow-sm">
                <a href="{{route('businessPromotion.create')}}"
        ...
        <div>
            <form action="{{route('businessPromotion.list')}}" method="get" class="w-full">
                <div class="flex items-center justify-center mb-10">
                    ...
                    <div class="mt-1.5">
                        ...
                        <a href="{{route('businessPromotion.list')}}"
        ...
        <div class="border-b border-gray-200 shadow sm:rounded-lg">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach($businessPromotion as $key=>$data)
                    <tr>
                        ...
                        <td class="flex px-8 py-8 space-x-2 text-sm font-medium text-right whitespace-nowrap">
                            <a title="Edit" href="{{route('businessPromotion.edit',$data->id)}}"
                            ...
                            <a title="Delete" href="{{route('businessPromotion.delete',$data->id)}}"
