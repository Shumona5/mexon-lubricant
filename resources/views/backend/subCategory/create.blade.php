...
@endsection
@section('main')
<form action="{{route('subCategory.store')}}" method="post" class=" px-6 py-6 rounded-md space-y-7" enctype="multipart/form-data">
    @csrf
    <div class="bg-white py-12 rounded-lg shadow-md">
        ...
        <div class="px-10">
            <label for="first_image" class="block text-sm leading-5 font-medium text-gray-700">
                First Product Image <span class="text-red-600"> * </span> <a class="text-blue-600 underline" href="https://squoosh.app/" target="_blank">Resize here</a> <br>
        ...
        <div class="px-10">
            <label for="second_image" class="block text-sm leading-5 font-medium text-gray-700">
                Second Product Image <span class="text-red-600"> * </span> <a class="text-blue-600 underline" href="https://squoosh.app/" target="_blank">Resize here</a> <br>
                <span class="text-black"> The size of height and width should be the same for 1:1 ratio </span>
            </label>
            <div class="mt-1 relative rounded-md shadow-sm">
        ...
        <div class="px-10">
            ...
            <div class="mt-1 relative rounded-md shadow-sm">
                <input  id="pdf_image" value="{{ old('pdf_image') }}" name="pdf_image" type="file" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:ring-2 focus:border-blue-200 focus:outline-none"  />
            </div>
            @error('pdf_image')
            <p class="text-red-600 mt-5">{{ $message }}</p>
            @enderror
