    ...
    <div class="flex items-center justify-between px-9">
        <div class="">
            <span class="inline-flex rounded-md shadow-sm">
                <a href="{{route('home.image.create')}}"
        ...
        <div>
            <form action="{{route('home.image')}}" method="get" class="w-full">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="text-sm text-gray-900">
                            <div class="ml-4">
                                <div class="text-sm font-medium text-gray-900">
                                    <img width="150 px" src="{{$homeImage->first_image}}"
                        ...
                        <td class="text-sm text-gray-900">
                            <div class="ml-4">
                                <div class="text-sm font-medium text-gray-900">
                                    <img width="150 px" src="{{$homeImage->second_image}}"
                                        class="object-contain rounded-full h-14 w-14" alt="No Image">
                                </div>
                            </div>
                        </td>
                        <td class="text-sm text-gray-900">
                            <div class="ml-4">
                                <div class="text-sm font-medium text-gray-900">
                                    <img width="150 px" src="{{$homeImage->third_image}}"
                                        class="object-contain rounded-full h-14 w-14" alt="No Image">
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="flex px-8 py-8 space-x-2 text-sm font-medium text-right whitespace-nowrap">
                            <a title="Edit" href="{{route('home.image.edit',$homeImage->id)}}"
                            ...
                            <a title="Delete" href="{{route('home.image.delete',$homeImage->id)}}"
