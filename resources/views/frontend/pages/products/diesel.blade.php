...
<div class="pdf">
    ...
    <a href="{{url('/frontend/image/Mexon DriveX TDS 20W-50.pdf')}}" target="_blank"><img src="{{url('/frontend/image/pdf.webp')}}" alt="" ></a>
</div>
</section>
<div>
...
<div class="container">
    <div class="row">
        <div class="col-md-8">
            ...
            <p style="font-size: 16px; font-family: Arial, Helvetica, sans-serif; color: slategray; font-weight: 200px;">
                <b>Pack size: 20 | 205 Liters</b>
            </p>
        </div>
        <div class="col-md-4" style="padding-top: 10px;">
            <img src="{{url('/frontend/image/Diesel8.png')}}" alt="" height="350px" width="350px">
        </div>
    </div>
</div>
